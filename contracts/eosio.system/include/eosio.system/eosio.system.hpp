...
namespace eosiosystem {
   ...
   static constexpr double   continuous_rate       = 0.4879;          // 5% annual rate
   ...
   static constexpr int64_t  votepay_factor        = 5;                // 20% of the producer pay
   static constexpr uint32_t refund_delay_sec      = 3 * seconds_per_day;
   static constexpr uint32_t _maxbp                = 7;
